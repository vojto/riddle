...
Klient sa identifikuje vo forme session id. Študent môe ma priradené svoje meno, ale nemusí. Z toho vyplıva, e hlasovanie môe by do istej formy anonymné.
